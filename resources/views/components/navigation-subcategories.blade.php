        ...
        <div>
            <ul>
                ...
                @foreach ($categoria->subcategorias as $subcategoria)
                    <li>
                        <a href="{{ route('categorias.show', $categoria) . '?subcategory=' . $subcategoria->slug }}"
                            class="text-trueGray-600 inline-block font-semibold py-1 px-4 hover:text-orange-600">
